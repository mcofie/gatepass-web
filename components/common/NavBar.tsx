...
export function NavBar() {
    ...
    if (pathname === '/' || pathname.startsWith('/checkout') || pathname.startsWith('/i/') || pathname.startsWith('/our-offering') || pathname.startsWith('/my-tickets') || pathname.startsWith('/claim/') || pathname.startsWith('/dashboard') || pathname.startsWith('/events/') || pathname.startsWith('/ticket/') || pathname === '/login' || pathname === '/privacy-policy' || pathname === '/terms-of-service' || pathname.startsWith('/onboarding')) return null
