                ...
                <div className={isStaff ? "md:col-span-1" : "md:col-span-2"}>
                    <div className="bg-white dark:bg-[#111] rounded-3xl border border-gray-100 dark:border-white/10 shadow-[0_2px_40px_rgba(0,0,0,0.04)] overflow-hidden">
                        <div className="px-8 py-6 border-b border-gray-100 dark:border-white/10 flex justify-between items-center">
                            ...
                            <span className="px-3 py-1 bg-gray-100 dark:bg-white/10 rounded-full text-xs font-bold text-gray-600 dark:text-gray-400">
                        ...
                        {staff.length > 0 ? (
                            <div className="divide-y divide-gray-50 dark:divide-white/5">
                                {staff
                                    ...
                                    .map((member) => (
                                        <div key={member.id} className="p-6 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors flex items-center justify-between group">
                                            <div className="flex items-center gap-4">
                                                <div className="relative">
                                                    ...
                                                    {(member.check_in_count || 0) > 0 && (
                                                        <div className="absolute -top-1 -right-1 bg-green-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full border-2 border-white dark:border-[#111]">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-gray-900 dark:text-white flex items-center gap-2">
                                                        {member.name}
                                                        {(member.check_in_count || 0) > 0 && (
                                                            <span className="bg-green-50 dark:bg-green-500/10 text-green-700 dark:text-green-400 text-[10px] px-2 py-0.5 rounded-full uppercase tracking-wide font-bold">
                                            ...
                                            <div className="flex items-center gap-6">
                                                <div className="text-right">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <code className="bg-black/5 dark:bg-white/10 px-2 py-1 rounded text-sm font-bold text-black dark:text-white font-mono tracking-wider">
                                                            {member.access_code}
                                                        </code>
                                                        <button
                                                            onClick={() => {
                            ...
                            <div className="flex flex-col items-center justify-center py-16 text-center animate-fade-in bg-gray-50/50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-white/10 border-dashed m-6">
                                <div className="w-16 h-16 bg-white dark:bg-white/10 rounded-full flex items-center justify-center mb-4 shadow-sm border border-gray-100 dark:border-white/5">
                                    <ShieldCheck className="w-8 h-8 text-gray-300 dark:text-gray-500" />
                                </div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">No staff members yet</h3>
